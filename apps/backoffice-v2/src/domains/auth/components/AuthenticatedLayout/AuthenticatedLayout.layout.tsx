...
export const AuthenticatedLayout: FunctionComponent = () => {
  ...
  console.log(`AuthenticatedLayout: shouldRedirect: ${shouldRedirect}, isLoading: ${isLoading}, redirectUnauthenticatedTo: ${redirectUnauthenticatedTo}, location: ${location}`);

  if (isLoading) return <FullScreenLoader />;

  if (shouldRedirect) {
    console.log('Redirecting to:', redirectUnauthenticatedTo);
    return (
      <Navigate
